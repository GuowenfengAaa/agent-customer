...
// plugins
export { useRequest, UseRequestProvider, request, getRequestInstance } from 'D:/movies-agent/agent-customer/src/.umi/plugin-request';
// plugins types.d.ts
export * from 'D:/movies-agent/agent-customer/src/.umi/plugin-request/types.d';
// @umijs/renderer-*
...
export type { History, ClientLoader } from 'D:/movies-agent/agent-customer/node_modules/@umijs/renderer-react'
// umi/client/client/plugin
export { ApplyPluginsType, PluginManager } from 'D:/movies-agent/agent-customer/node_modules/umi/client/client/plugin.js';
